...
public final class GroupInviteLinkUrlTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(
      ...
      givenGroup().withMasterKey("a501335111fa04e3756c24b6eb87264e2dfb622e8e1d339179765410776c0488")
                  ...
                  .expectUrl("https://group.qianli.chat/#CjQKIKUBM1ER-gTjdWwktuuHJk4t-2Iujh0zkXl2VBB3bASIEhDwi34i-5OMAl5sFYt9VElW"),
      ...
      givenGroup().withMasterKey("2ca23c04d7cf60fe04039ae76d1912202c2a463d345d9cd48cf27f260dd37f6f")
                  ...
                  .expectUrl("https://group.qianli.chat/#CjQKICyiPATXz2D-BAOa520ZEiAsKkY9NF2c1IzyfyYN039vEhAnNEV8As5R2nGtC2LzwiL3"),
      ...
      givenGroup().withMasterKey("00f7e0c2a71ab064cc3ced4c04f08d7b7ef4b84b2c2206f69833be6cfe34df80")
                  ...
                  .expectUrl("https://group.qianli.chat/#CjQKIAD34MKnGrBkzDztTATwjXt-9LhLLCIG9pgzvmz-NN-AEhCbwyTuxDfP2mrluK779H7o"),

      givenGroup().withMasterKey("00f7e0c2a71ab064cc3ced4c04f08d7b7ef4b84b2c2206f69833be6cfe34df80")
                  .andPassword("9b")
                  .expectUrl("https://group.qianli.chat/#CiUKIAD34MKnGrBkzDztTATwjXt-9LhLLCIG9pgzvmz-NN-AEgGb"),

      givenGroup().withMasterKey("2ca23c04d7cf60fe04039ae76d1912202c2a463d345d9cd48cf27f260dd37f6f")
                  .andPassword("2734457c02ce51da71ad0b62f3c222f7")
                  .expectUrl("qlcy://group.qianli.chat/#CjQKICyiPATXz2D-BAOa520ZEiAsKkY9NF2c1IzyfyYN039vEhAnNEV8As5R2nGtC2LzwiL3")
    );
  }
  ...
  public void can_reconstruct_url() {
    ...
    if (urlToCompare.startsWith("qlcy")) {
      urlToCompare = urlToCompare.replace("qlcy", "https");
    }
